...
try {
    ...
    Response::validateRequired($input, ['titulo', 'director', 'ano_lanzamiento', 'duracion_minutos', 'genero']);
    ...
    $genero = Response::sanitizeInput($input['genero']);
    ...
    if (!Utils::validateMovieYear($anoLanzamiento)) {
    ...
    $generoStmt->bindParam(':genero', $genero);
    $generoStmt->execute();
